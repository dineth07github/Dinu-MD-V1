...
async function connectToWA() {
  ...
  danuwa.ev.on('connection.update', async (update) => {
    ...
    if (connection === 'close') {
      ...
      console.log('✅ Dinu-MD connected to WhatsApp');

      const up = `Dinu-MD connected ✅\n\nPREFIX: ${prefix}`;
      await danuwa.sendMessage(ownerNumber[0] + "@s.whatsapp.net", {
        image: { url: `https://github.com/dineth07github/Dinu-MD-V1/blob/main/images/logo.png?raw=true` },
        caption: up
      });
